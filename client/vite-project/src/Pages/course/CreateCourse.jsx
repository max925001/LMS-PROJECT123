...
<button className='w-full py-3 rounded-sm font-semibold text-lg cursor-pointer bg-yellow-600 hover:bg-yellow-400  transition-all ease-in-out duration-300' type='submit'>Create Course</button>
